...
public class FrmQLHoaDon extends JFrame implements ActionListener {
	...
	private JLabel lblMaHD, lblNgayLap, lblSDT, lblHoKH, lblTenKH, lblGioiTinh, lblDiaChi, lblCMND, lblNgaySinh,
			lblTenThuoc, lblTuoi, lblTimThuoc;
...
//		.forEach(item -> item.setPreferredSize(dms_lbl));
		...
		String[] tb = new String[] { "STT", "MaHoaDon", "MaThuoc", "LoaiThuoc", "TenThuoc", "DonGia", "SoLuong",
				"ThanhTien", "NgayLapHD", "HoTenKH", "SDTKH", "GioiTinh", "Tuoi" };
